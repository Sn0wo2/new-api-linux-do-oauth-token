...
A helper library to authenticate new-api with linux.do oauth and retrieve session

---

[![Python CI](https://github.com/Sn0wo2/new-api-linux-do-oauth-token/actions/workflows/py.yml/badge.svg)](https://github.com/Sn0wo2/new-api-linux-do-oauth-token/actions/workflows/py.yml)
